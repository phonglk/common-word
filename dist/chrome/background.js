...
var _defaultSync = __webpack_require__(18);

var _defaultSync2 = _interopRequireDefault(_defaultSync);
...
exports.default = function () {
  var _ref = _asyncToGenerator(function* () {
    ...
    if (hasSync !== true) {
      ...
      yield (0, _storage._set)(_defaultSync2.default);
...
Inline = __webpack_require__(23);

Pattern = __webpack_require__(2);

Utils = __webpack_require__(5);

ParseException = __webpack_require__(7);
...
Unescaper = __webpack_require__(24);

Escaper = __webpack_require__(21);

Utils = __webpack_require__(5);

ParseException = __webpack_require__(7);

DumpException = __webpack_require__(22);
...
var _preliminaryCheck = __webpack_require__(10);
...
function bindBrowserAction({ wordList }) {
  chrome.browserAction.onClicked.addListener(function (tab) {
    (0, _communication.sendMessageToTab)(tab.id, {
      event: _events.EVENT_BROWSER_ACTION_CLICK,
      wordList
    });
  });
}
